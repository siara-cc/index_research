...
int main1() {
    ...
    dx->put("paqqvnif", 8,  "qqap", 4);
    dx->put("oleiyqru", 8,  "ielo", 4);
    dx->put("vspblnfr", 8,  "bpsv", 4);
    dx->put("sgirvdih", 8,  "rigs", 4);
    dx->put("ablnhqqt", 8,  "nlba", 4);
    dx->put("lhnqvrcg", 8,  "qnhl", 4);
    dx->put("ysrvwjhv", 8,  "vrsy", 4);
    dx->put("kxwvnrtq", 8,  "vwxk", 4);
    dx->put("yqlpmrqu", 8,  "plqy", 4);
    dx->put("mknikeat", 8,  "inkm", 4);
    dx->put("gzqvlfbb", 8,  "vqzg", 4);
    dx->put("lnipjvqc", 8,  "pinl", 4);
    dx->put("umnfciab", 8,  "fnmu", 4);
    dx->put("kfglgxgx", 8,  "lgfk", 4);
    dx->put("xosakhbw", 8,  "asox", 4);
    dx->put("szypdxzn", 8,  "pyzs", 4);
    dx->put("tsokgzsr", 8,  "kost", 4);
    dx->put("nmqntdwl", 8,  "nqmn", 4);
    dx->put("aipyuius", 8,  "ypia", 4);
    dx->put("qushjluk", 8,  "hsuq", 4);
    dx->put("nejqxveu", 8,  "qjen", 4);
    dx->put("zotyfsor", 8,  "ytoz", 4);
    dx->put("xgnehggf", 8,  "engx", 4);
    dx->put("snizdebv", 8,  "zins", 4);
    dx->put("pbjbqfgp", 8,  "bjbp", 4);
    dx->put("sdtepuub", 8,  "etds", 4);
    dx->put("nohlmktd", 8,  "lhon", 4);
    dx->put("dzadnvme", 8,  "dazd", 4);
    dx->put("awuurbqr", 8,  "uuwa", 4);
    dx->put("cpwzlohd", 8,  "zwpc", 4);
    dx->put("faphpsxg", 8,  "hpaf", 4);
    dx->put("mbzlgcrl", 8,  "lzbm", 4);
    dx->put("bqrivbtf", 8,  "irqb", 4);
    dx->put("ptodimag", 8,  "dotp", 4);
    dx->put("dbpkrdcs", 8,  "kpbd", 4);
    dx->put("ubqrapwn", 8,  "rqbu", 4);
    dx->put("neaflula", 8,  "faen", 4);
    dx->put("cekyegxd", 8,  "ykec", 4);
    dx->put("uecskqnl", 8,  "sceu", 4);
    dx->put("ffjphcld", 8,  "pjff", 4);
