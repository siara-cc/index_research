...
int main1() {
    ...
    dx->put("<<UmtwB{", 8, "mU<<", 4);
    dx->put("kC[\"/l+B", 8, "\"[Ck", 4);
    dx->put("j2!45D,Q", 8, "4!2j", 4);
    dx->put("rKcE{|Fk", 8, "EcKr", 4);
    dx->put("U+V=K(Ei", 8, "=V+U", 4);
    dx->put("6+C$Dv6i", 8, "$C+6", 4);
    dx->put("0\"=@IyBU", 8, "@=\"0", 4);
    dx->put("ZIV-Wv(E", 8, "-VIZ", 4);
    dx->put("1&Cev)6$", 8, "eC&1", 4);
    dx->put("PJ=E>wS0", 8, "E=JP", 4);
    dx->put("<7fNa,D+", 8, "Nf7<", 4);
    dx->put("oOc4C6(6", 8, "4cOo", 4);
    dx->put("I-a=0F@l", 8, "=a-I", 4);
    dx->put("s2ODJFb+", 8, "DO2s", 4);
    dx->put("$MCBmhey", 8, "BCM$", 4);
    dx->put(",uWE<{hn", 8, "EWu,", 4);
    dx->put("H([$\\F^,", 8, "$[(H", 4);
    dx->put("d(hb?gs|", 8, "bh(d", 4);
    dx->put("*k|M8y7\"", 8, "M|k*", 4);
    dx->put("7y-G\"k|A", 8, "G-y7", 4);
    dx->put("H^RJ.O_S", 8, "JR^H", 4);
    dx->put("Fms;Bgdm", 8, ";smF", 4);
    dx->put("p(3~D`>{", 8, "~3(p", 4);
    dx->put("2zb~}JR^", 8, "~bz2", 4);
    dx->put("3]4N3Cl?", 8, "N4]3", 4);
    dx->put("?*K1]]mj", 8, "1K*?", 4);
    dx->put("m<5IVJx8", 8, "I5<m", 4);
    dx->put("sSr\"e|;\\", 8, "\"rSs", 4);
    dx->put("!i9tH.Zs", 8, "t9i!", 4);
    dx->put("$hTe&R^Y", 8, "eTh$", 4);
    dx->put("tN3VEM0f", 8, "V3Nt", 4);
    dx->put("d^ g^}il", 8, "g ^d", 4);
    dx->put("}*)tR|E+", 8, "t)*}", 4);
    dx->put("jXhuFR;g", 8, "uhXj", 4);
    dx->put("*CtVS}-E", 8, "VtC*", 4);
    dx->put("{yE76ndB", 8, "7Ey{", 4);
    dx->put("-G-iRg6\"", 8, "i-G-", 4);
    dx->put("%]IR:EZ3", 8, "RI]%", 4);
    dx->put("&MLp'(pw", 8, "pLM&", 4);
    dx->put("4))zs8'C", 8, "z))4", 4);
