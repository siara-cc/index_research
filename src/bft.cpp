...
byte *bft_node_handler::split(int16_t *pbrk_idx, byte *first_key,
    ...
    bft_iterator_status s(trie, PREFIX_LEN);
...
int16_t bft_node_handler::insertCurrent(int is_main) {
    byte key_char;
    int16_t ret, ptr, pos;
    ret = pos = 0;
