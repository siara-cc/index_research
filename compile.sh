...
g++ -I./hdr -I./src -O3 -Wall -c -fmessage-length=0 -o Release/src/octp.o ./src/octp.cpp
g++ -I./hdr -I./src -O3 -Wall -c -fmessage-length=0 -o Release/src/bfqs.o ./src/bfqs.cpp
...
cd Release
g++ -o ../huge_db src/rb_tree.o src/basix.o src/huge_db.o src/dfox.o src/dfos.o src/dfqx.o src/linex.o src/bfos.o src/octp.o src/bfqs.o src/dft.o src/bft.o src/art.o src/GenTree.o src/univix_util.o
